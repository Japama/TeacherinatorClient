            ...
            <table className="min-w-full border border-gray-200 bg-white shadow-lg text-center">
                <thead>
                    <tr className="h-[70px] border-b bg-[#141B29] text-[#FFFFFF]">
                        <th className="px-6 py-4 text-center w-1/6">Nombre</th>
                        <th className="px-6 py-4 text-center w-1/6">Administrador</th>
                        <th className="px-6 py-4 text-center w-1/6">Docente</th>
                        <th className="px-6 py-4 text-center w-1/6">Departamento</th>
                        <th className="px-6 py-4 text-center w-1/6">Activo</th>
                        <th colSpan={2} className="px-6 py-4 text-center w-1/6">Editar</th>
                    ...
                    <tr className="h-[70px] border-b bg-[#596B99] text-[#000000]">
                        ...
                        <td className="px-6 py-4 text-center">
                            <button
                                ...
                                className={`mx-2 p-2 rounded ${filters.is_admin === 'true' ? 'bg-green-500 text-white' : 'bg-gray-300'}`}> ✔ </button>
                            <button
                                onClick={() => handleFilterButtonClick('is_admin', 'false')}
                                className={`mx-2 p-2 rounded ${filters.is_admin === 'false' ? 'bg-red-500 text-white' : 'bg-gray-300'}`}> ✘ </button>
                        </td>
                        <td className="px-6 py-4 text-center">
                        ...
                        <td className="px-6 py-4 text-center">
                            <button
                                ...
                                className={`mx-2 p-2 rounded ${filters.active === 'true' ? 'bg-green-500 text-white' : 'bg-gray-300'}`}> ✔ </button>
                            <button
                                onClick={() => handleFilterButtonClick('active', 'false')}
                                className={`mx-2 p-2 rounded ${filters.active === 'false' ? 'bg-red-500 text-white' : 'bg-gray-300'}`}> ✘ </button>
                        </td>
