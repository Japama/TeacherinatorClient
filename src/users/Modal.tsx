            ...
            <div className=" rounded-md modal-content w-full mx-auto lg:w-[500px] drop-shadow-lg bg-white p-12" style={{ position: 'relative', margin: '0 auto', top: '50%', transform: 'translateY(-50%)' }}>
                ...
                <form id="userForm" onSubmit={handleSubmit} className="space-y-5">
                    <div className="relative">
                        ...
                        <input id="username" type="text" name="username" value={editedUser.username} onChange={handleChange} className=" text-center rounded-md  p-3 block w-full px-10 drop-shadow-lg outline-none" />
                    </div>
                    <div className="relative">
                        <label htmlFor="teacher" className="block">Profesor:</label>
                        <input id="teacher" type="checkbox" name="teacher" checked={!!editedUser.teacher} onChange={handleChange} className="rounded-md  p-3 block w-full px-10 drop-shadow-lg outline-none" />

                    </div>
                    <div className="relative">
                        <label htmlFor="department" className="block">Departamento:</label>
                        <select id="department" name="department" value={editedUser.department} onChange={handleSelectChange} disabled={!editedUser.teacher} className="rounded-md  p-3 block w-full px-10 drop-shadow-lg outline-none">
