    ...
    return (
        <>
            <tr className="h-[70px] border-b bg-gray-700 text-[#FFFFFF]">
                ...
                <td className="px-6 py-4 text-start"> {user.is_admin ? '✅' : '❌'} </td>
                <td className="px-6 py-4 text-start"> {user.department_id != 1 ? '✅' : '❌'} </td>
                <td className="px-6 py-4 text-start"> {user.department !== null ? user.department?.name : '❌'} </td>
                <td className="px-6 py-4 text-start"> {user.active ? '✅' : '❌'} </td>
                <td className="px-6 py-4 text-start">
