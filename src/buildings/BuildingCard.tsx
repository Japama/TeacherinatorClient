...
function BuildingCard(props: BuildingCardProps) {
    const { building, onEdit } = props;
    ...
    const handleDeleteClick = () => {
        confirmAlert({
            ...
            buttons: [
                {
                    label: 'Sí',
                    onClick: () => props.onDelete(building)
                },
                {
                    label: 'No',
                }
    ...
    return (
        <>
            {/* <Modal isOpen={isModalOpen} onClose={closeModal} onEdit={onEdit} building={building} /> */}
