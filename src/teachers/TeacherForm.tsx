...
function TeacherForm(props: TeacherFormProps) {
    const { isOpen, isCreate, onClose, onEdit, onCreateUser, teacher, departments, users, teachers, allTeachers, onCreate } = props;
    ...
    const handleSubmit = async (event: React.FormEvent) => {
        ...
        if (isNewUser && props.onCreateUser) {
            const newUser = await props.onCreateUser(newUserName);
