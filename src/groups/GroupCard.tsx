...
function GroupCard(props: GroupCardProps) {
    ...
    return (
        ...
        <tr className="h-[70px] border-b bg-gray-100 text-gray-800">
                ...
                <td className="px-6 py-4 text-center">{getStageText(group.stage)}</td>
                <td className="px-6 py-4 text-center">{group.course}º {group.letter}</td>
                <td className="px-6 py-4 text-center">{group.tutor_name}</td>
                <td className="px-6 py-4 text-center flex"><button onClick={handleEditClick} className="flex items-center rounded-full bg-blue-600 px-4 py-2 font-bold text-white shadow-md transition-all duration-300 hover:bg-blue-700 mx-auto">
                    Editar </button>
                {/* </td>
                <td className="px-6 py-4 text-center"> */}
                    <button onClick={() => handleDeleteClick()} className="flex items-center rounded-full bg-red-500 px-4 py-2 font-bold text-white shadow-md transition-all duration-300 hover:bg-red-700 mx-auto">Eliminar</button></td>
            </tr>
        </>
    );
}
